...
public class ModelFoolSkeleton extends ModelZombie
{
	private static final String __OBFID = "CL_00000857";

	public ModelFoolSkeleton()
	{
		this( 0.0F );
	}

	public ModelFoolSkeleton(float p_i1156_1_)
	{
	...
	{
		this.aimedBow = ((EntityFoolSkeleton) p_78086_1_).getSkeletonType() == 1;
