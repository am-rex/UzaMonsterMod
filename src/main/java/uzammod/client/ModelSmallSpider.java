...
public class ModelSmallSpider extends ModelBase
{
    ...
    {
    	EntitySmallSpider spider = (EntitySmallSpider)p_78088_1_;
        GL11.glPushMatrix();
        this.setRotationAngles(p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, p_78088_7_, p_78088_1_);
        GL11.glTranslated(0.0, 1.5 - spider.getScale()*1.5, 0.0);
        GL11.glScaled(spider.getScale(), spider.getScale(), spider.getScale());
