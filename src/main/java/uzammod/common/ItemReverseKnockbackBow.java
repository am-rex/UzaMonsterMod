...
public class ItemReverseKnockbackBow extends Item
{
	public static final String[] bowPullIconNameArray = new String[] { "pulling_0", "pulling_1", "pulling_2" };
	@SideOnly(Side.CLIENT)
	private IIcon[] iconArray;

	public ItemReverseKnockbackBow()
	{
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
	{
		...
		if( flag || p_77615_3_.inventory.hasItem( Items.arrow ) )
		{
			...
			EntityReverseKnockbackArrow entityarrow = new EntityReverseKnockbackArrow( p_77615_2_, p_77615_3_, f * 2.0F );
	 ...
	 */
	@SideOnly(Side.CLIENT)
    public IIcon getItemIconForUseDuration(ItemStack p_70620_1_, int itemInUseCount, boolean hasArrow)
	{
		if(!hasArrow)
		{
			return getIcon( p_70620_1_, 0 );
		}
		...
		int j = getMaxItemUseDuration( p_70620_1_ ) - itemInUseCount;
		if( j > 18)
		{
