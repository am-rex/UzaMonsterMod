...
public class EntityFoolSkeleton extends EntityModMobBase implements IRangedAttackMob
{
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack( this, 1.0D, 20, 60, 15.0F );
	private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide( this, EntityPlayer.class, 1.2D, false );
	private static final String __OBFID = "CL_00001697";

	public EntityFoolSkeleton(World p_i1741_1_)
	{
		super( p_i1741_1_ );
	...
	protected void addRandomArmor()
	{
		...
		this.setCurrentItemOrArmor( 0, new ItemStack( UzaMonsterMod.itemRkBow ) );
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
	{
		...
		if(getHeldItem() != null)
		{
			getHeldItem().addEnchantment( Enchantment.power, 4 );
			getHeldItem().addEnchantment( Enchantment.punch, 3 );
		}
	...
	{
		EntityReverseKnockbackArrow entityarrow = new EntityReverseKnockbackArrow( this.worldObj, this, p_82196_1_, 1.6F, (float) (14 - this.worldObj.difficultySetting.getDifficultyId() * 4) );
