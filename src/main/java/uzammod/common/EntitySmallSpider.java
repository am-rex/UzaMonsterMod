...
public class EntitySmallSpider extends EntityModMobBase
{
	...
	public float getScale()
	{
		...
		float s = (float) ((double) getHealth() / getMaxHealth()) * 2;
	...
	public void onUpdate()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(getScale() * 4);

		this.setSize(1.4F * getScale(), 0.9F * getScale());
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
	{
		...
		{
			p_110161_1_1 = new EntitySmallSpider.GroupData();
		...
		//			* this.worldObj.func_147462_b(this.posX, this.posY, this.posZ))
			{
				((EntitySmallSpider.GroupData) p_110161_1_1).func_111104_a(this.worldObj.rand);
			}
		}

		if (p_110161_1_1 instanceof EntitySmallSpider.GroupData)
		{
			int i = ((EntitySmallSpider.GroupData) p_110161_1_1).field_111105_a;

			if (i > 0 && Potion.potionTypes[i] != null)
			{
				this.addPotionEffect(new PotionEffect(i, Integer.MAX_VALUE, 1));
			}
		}
